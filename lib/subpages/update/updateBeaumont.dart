...
class UpdateBeaumont extends StatefulWidget {
  UpdateBeaumont({Key key}) : super(key: key);

  @override
  _UpdateBeaumontState createState() => _UpdateBeaumontState();
}

class _UpdateBeaumontState extends State<UpdateBeaumont> {
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: Column(
          ...
          children: [
            Container(
              child: Text("Update Current Beaumont Status",
                  style:
